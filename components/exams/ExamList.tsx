...
import { Exam, ExamListResponse, DEFAULT_PAGINATION } from '@/types/exam';
import { ExamCard, ExamCardSkeleton } from '@/components/exams/ExamCard';
...
export function ExamEmptySearch({ onReset }: { onReset: () => void }) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    >
      ...
      <p className="mb-6 max-w-md text-sm text-slate-500 dark:text-slate-400">
        Aucun résultat ne correspond à ta recherche. Essaye de modifier tes filtres
        ou ta requête.
      </p>
